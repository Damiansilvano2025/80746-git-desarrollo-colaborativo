...
git branch feature/feature/ramas>
```
...
## Listar todas las ramas en detalle (locales y remotas)
...
> Y si quiero cambiar entre las ultimas 2 ramas que se usaron
...
**IMPORTANTE**: Es que para hacer una fusión. Tengo que estar en la rama destino. O sea si me quiero traer los cambios de la rama feature/ramas a la rama main, tengo que estar parado en la rama main y traerme los cambios de la otra rama

```sh
git switch main
git marge feature/ramas
```
